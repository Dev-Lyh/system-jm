...
def read_hours_one(quantity_of_pages, path, destiny_path):
    ...
    while index_of_pages < int(quantity_of_pages):
        sg.popup('Processando...', f'Páginas concluídas: {index_of_pages + 1} de {quantity_of_pages}', non_blocking=True, auto_close_duration=3, keep_on_top=True, auto_close=True, font=('Calibri', 14))
...
def read_hours_two(quantity_of_pages, path, destiny_path):
    ...
    while index_of_pages < int(quantity_of_pages):
        sg.popup('Processando...', f'Páginas concluídas: {index_of_pages + 1} de {quantity_of_pages}', non_blocking=True, auto_close_duration=2, keep_on_top=True, auto_close=True, font=('Calibri Bold', 14))
